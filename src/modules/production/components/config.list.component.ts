          ...
          <div class="col-md-6 no-padding">
            <button
              *ngIf="module && module.add"
              mat-raised-button
              color="success"
              [routerLink]="['/admin/production/config/create/0']"
            >
          ...
          <table class="table">
            <thead>
              <tr>
                ...
                <th class="text-right" *ngIf="module.edit || module.delete">
                  Acción
                </th>
              </tr>
            </thead>
                ...
                <td *ngIf="module.edit || module.delete">
                  <mat-menu #appMenu="matMenu">
                    <button
                      ...
                      *ngIf="module.edit"
                      [routerLink]="[
                        '/admin//production/config/create/' + config._id
                      ]"
                    >
...
export class ConfigurationListComponent implements AfterViewInit {
  ...
  paginate(params: any, query?: string) {
    ...
    this.visibleInvoices = this.invoices
      .filter((config: IProductionConfig) => {
        return (
          !query ||
          JSON.stringify(config).toLowerCase().indexOf(query.toLowerCase()) >= 0
        );
      })
