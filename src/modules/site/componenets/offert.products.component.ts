                            ...
                            <div class="tp-banner">
                                <ul>
                                    ...
                                    <li data-transition="random" data-slotamount="7" data-masterspeed="300" data-saveperformance="off" *ngFor="let product of product_offerts">
                                        <!-- MAIN IMAGE -->
                                        <a [routerLink]="['/site/product/'+ product._id + '/details']"><img style="height: 100%" [src]="product.image" onerror="this.src='assets/images/empty.png';" alt="slider" data-bgposition="center bottom" data-bgfit="contain" data-bgrepeat="no-repeat"></a>
