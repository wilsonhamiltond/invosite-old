...
const application_modules = [
    {
        "name" : "Listado de acuse",
        "url" : "/admin/acknowledgment/list",
        "print" : true,
        "delete" : true,
        "edit" : true,
        "add" : true
    },{
        "name" : "Creación de acuse",
        "url" : "/admin/acknowledgment/create/:_id",
        "print" : true,
        "delete" : true,
        "edit" : true,
        "add" : true
    },{
        "name" : "Impresión de acuse",
        "url" : "/admin/acknowledgment/:_id/print",
        "print" : true,
        "delete" : true,
        "edit" : true,
        "add" : true
    },{
        "name" : "Reporte de acuse",
        "url" : "/admin/report/acknowledgment",
        "print" : true,
        "delete" : true,
        "edit" : true,
        "add" : true
